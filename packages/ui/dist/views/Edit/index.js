...
export function DefaultEditView({
  ...
  }, [reportUpdate, id, entitySlug, user, collectionSlug, userSlug, incrementVersionCount, updateSavedDocumentData, onSaveFromContext, isEditing, depth, getDocPermissions, globalSlug, autosaveEnabled, refreshCookieAsync, adminRoute, locale, router, resetUploadEdits, getDocPreferences, getFormState, docPermissions, operation, schemaPathSegments, isLockingEnabled, setDocumentIsLocked, startRouteTransition, redirectAfterCreate]);
  ...
  return /*#__PURE__*/_jsx("main", {
    ...
    children: /*#__PURE__*/_jsx(OperationProvider, {
      ...
      children: /*#__PURE__*/_jsxs(Form, {
        ...
        }), isLockingEnabled && shouldShowDocumentLockedModal && !isReadOnlyForIncomingUser && /*#__PURE__*/_jsx(DocumentLocked, {
        ...
        }), !isReadOnlyForIncomingUser && preventLeaveWithoutSaving && /*#__PURE__*/_jsx(LeaveWithoutSaving, {}), !isInDrawer && /*#__PURE__*/_jsx(SetDocumentStepNav, {
